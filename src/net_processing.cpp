...
// Copyright (c) 2022 Pcoin developers
...
static constexpr int64_t STALE_CHECK_INTERVAL = 2.5 * 60 * 1000 * 10000;
...
static constexpr int STALE_RELAY_AGE_LIMIT = 30 * 24 * 60 * 60 * 10000 * 10000;
