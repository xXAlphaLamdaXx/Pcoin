...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 69120;
        consensus.BIP16Height = 2; // powers of two
        consensus.BIP34Height = 4;
        consensus.BIP34Hash = uint256S("fa09d204a83a768ed5a7c8d441fa62f2043abf420cff1226c7b4329aeb9d51cf");
        consensus.BIP65Height = 8; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        consensus.BIP66Height = 16; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        ...
        vSeeds.emplace_back("192.168.2.2");
...
public:
    CTestNetParams() {
        ...
        consensus.BIP65Height = 4; // 8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573
        consensus.BIP66Height = 8; // 8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nSubsidyHalvingInterval = 16;
        consensus.BIP16Height = 0;
        consensus.BIP34Height = 2; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 4; // BIP65 activated on regtest (Used in functional tests)
        consensus.BIP66Height = 8; // BIP66 activated on regtest (Used in functional tests)
